...
const Sidebar = () => {
  ...
  const baseItemStyle = `p-2 sm:p-4 transition-all duration-300 hover:bg-text/10 hover:text-text font-medium text-xs sm:text-sm flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-0.5 sm:gap-2 rounded-md flex-1 sm:flex-none`;
  const activeItemStyle = `font-sans font-semibold text-text bg-text/10 tracking-wide border-b-2 sm:border-b-0 sm:border-r-2 border-primary`;
  const inactiveItemStyle = `bg-none text-text/40`;

  return (
    <div
      className="bg-neutral/95 text-text p-2 sm:p-4 z-50 transition-all duration-300
    ...
    >
      <div className="mb-6 hidden lg:block">
        <h2 className="text-text font-bold text-xl">Librarian Portal</h2>
        <p className="text-[12px] text-text/40">Central Library Admin</p>
      </div>
            ...
            return (
              ...
              >
                ...
                >
                  <Icon
                    size={20}
                    className={isActive ? "text-text" : "text-text/40"}
                  />
          ...
          {hiddenMobileItems.length > 0 && (
            <li className="relative flex-1 flex justify-center">
              <button
                ...
                className={`p-2 w-full flex flex-col items-center justify-center rounded-md text-text/40 hover:text-text hover:bg-text/10 transition-all ${showMoreMenu ? "text-text bg-text/10" : ""}`}
              >
                  ...
                  {hiddenMobileItems.map((item, i) => {
                    ...
                    return (
                      <Link
                        ...
                        className={`flex items-center gap-3 p-3 rounded-md text-sm font-medium transition-all ${isActive ? "bg-text/10 text-text font-semibold" : "text-text/60 hover:bg-text/5 hover:text-text"}`}
                      >
                        <Icon
                          size={18}
                          className={isActive ? "text-text" : "text-text/40"}
